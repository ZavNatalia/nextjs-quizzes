        ...
        junior: [
            {
                ...
                explanation:
                    'Командная работа требует прозрачной коммуникации, чтобы избежать недопонимания, синхронизировать действия и повысить эффективность.',
            },
            {
                name: 'q2',
                ...
                explanation:
                    'Подтверждение и уточнение договорённостей помогает убедиться, что все участники понимают задачи одинаково, снижая риск ошибок.',
            },
            {
                name: 'q3',
                ...
                explanation:
                    'Открытое информирование команды и официальное оформление больничного помогает всем адаптироваться к изменению планов и сохранять здоровье.',
            },
            {
                name: 'q4',
                ...
                explanation:
                    'Эффективное участие в обсуждении предполагает активное слушание и уважительное предложение своих идей.',
            },
            {
                name: 'q5',
                ...
                explanation:
                    'Открытое признание ошибок и анализ причин помогает расти профессионально и поддерживать доверие в команде.',
            },
        ],
        middle: [
            {
                ...
                explanation:
                    'Открытое обсуждение конфликта и стремление к взаимопониманию помогает сохранить продуктивную рабочую атмосферу.',
            },
            {
                name: 'q7',
                ...
                explanation:
                    'Определение приоритетов по срочности и важности позволяет фокусироваться на задачах, влияющих на результат.',
            },
            {
                name: 'q8',
                ...
                explanation:
                    'Переосмысление и уточнение полученного фидбэка помогает избежать неправильной интерпретации и демонстрирует открытость к развитию.',
            },
            {
                name: 'q9',
                ...
                explanation:
                    'Признание достижений вдохновляет сотрудников, усиливает вовлеченность и формирует позитивную командную культуру.',
            },
            {
                name: 'q10',
                ...
                explanation:
                    'Письменная фиксация договорённостей снижает риски недопонимания и помогает отслеживать ответственность сторон.',
            },
        ],
        senior: [
            {
                ...
                explanation:
                    'Наставничество и делегирование способствуют обучению, росту и повышению уверенности коллег.',
            },
            {
                name: 'q12',
                ...
                explanation:
                    'Честная коммуникация о сроках и ресурсах помогает формировать реалистичные ожидания и предотвращает разочарования.',
            },
            {
                name: 'q13',
                ...
                explanation:
                    'Уважительное отношение и стремление к взаимопониманию позволяют находить компромиссы даже в напряжённых ситуациях.',
            },
            {
                name: 'q14',
                ...
                explanation:
                    'Соблюдение баланса между работой и отдыхом снижает риск выгорания и повышает устойчивость команды в долгосрочной перспективе.',
            },
            {
                name: 'q15',
                ...
                correctAnswer: 'trust',
                explanation:
                    'Постоянное взаимодействие и открытость помогают формировать доверие, особенно в условиях удалённой работы.',
            },
        ],
    },
};
